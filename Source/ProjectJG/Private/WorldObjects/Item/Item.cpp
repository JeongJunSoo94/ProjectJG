...
void AItem::ItemInterp(float DeltaTime)
{
	...
	if (Character && ItemZCurve)
	{
		...
		const FRotator CameraRotation{ Character->GetCharacterCamera()->GetComponentRotation() };
...
void AItem::SetItemTransform(FTransform NewTransform)
{
	if (HasAuthority())
	{
		WorldTransform = NewTransform;
		OnRep_SetWorldTransform();
	}
}
...
void AItem::OnRep_SetWorldTransform()
{
...
void AItem::StartItemCurve(ABaseCharacter* Char, bool bForcePlaySound)
{
	Character = Char;
	...
	const double CameraRotationYaw{ Character->GetCharacterCamera()->GetComponentRotation().Yaw };
